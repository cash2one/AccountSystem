...
public class GrandMobileOAuthTokenRequest extends OAuthRequest {
	
	public GrandMobileOAuthTokenRequest(HttpServletRequest request) throws OAuthSystemException, OAuthProblemException {
        super(request);
    }

    @Override
    protected OAuthValidator<HttpServletRequest> initValidator() throws OAuthProblemException, OAuthSystemException {
        validators.put(GrantType.AUTHORIZATION_CODE.toString(), GrandMobileAuthorizationCodeValidator.class);
        validators.put(GrantType.REFRESH_TOKEN.toString(), GrandMobileRefreshTokenValidator.class);
