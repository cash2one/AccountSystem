package com.snda.grand.mobile.as.rest.oauth2.impl;

import static com.snda.grand.mobile.as.rest.util.Preconditions.checkOAuth2Scope;
...
import com.snda.grand.mobile.as.rest.oauth2.AuthorizationResource;
import com.snda.grand.mobile.as.rest.oauth2.SdoAuthResource;
import com.snda.grand.mobile.as.rest.oauth2.TokenResource;
import com.snda.grand.mobile.as.rest.oauth2.ValidateResource;
...
public class OAuth2ResourceImpl implements AuthorizationResource,
	...
	public Response sdoAuthorize(@Context HttpServletRequest request)
		...
		checkOAuth2Scope(request.getParameter("scope"), "authorize", request.getParameter("redirect_uri"));
	...
	@GET
	@Path("deny")
	public Response denyAuthorize(@Context HttpServletRequest resquest)
			throws ASOAuthProblemException {
		return oauth2ResourceProcessor.denyAuthorize(resquest);
	}
