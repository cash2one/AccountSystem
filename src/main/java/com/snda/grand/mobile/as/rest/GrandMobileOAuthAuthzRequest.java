...
public class GrandMobileOAuthAuthzRequest extends OAuthRequest {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(GrandMobileOAuthAuthzRequest.class);
	
	public GrandMobileOAuthAuthzRequest(HttpServletRequest request) throws OAuthSystemException, OAuthProblemException {
        super(request);
    }
...
//            validator.validateOptionalParameters(request);
    ...
    protected OAuthValidator<HttpServletRequest> initValidator() throws OAuthProblemException, OAuthSystemException {
        ...
        validators.put(ResponseType.CODE.toString(), GrandMobileCodeValidator.class);
